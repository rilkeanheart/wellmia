            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Commentable Item Id:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:commentInstance, field:'commentableItemId')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:commentInstance, field:'memberCreatorId')}</td>
