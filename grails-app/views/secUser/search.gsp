<head>
	...
	<title><g:message code='wellmia.security.ui.user.search'/></title>
</head>
...
<div>
	...
	<s2ui:form width='100%' height='375' elementId='formContainer'
	      titleCode='wellmia.security.ui.user.search'>
	...
	<g:form action='userSearch' name='userSearchForm'>
		...
		<table>
			...
			<tr>
				<td>&nbsp;</td>
				<td><g:message code='wellmia.security.ui.search.true'/></td>
				<td><g:message code='wellmia.security.ui.search.false'/></td>
				<td><g:message code='wellmia.security.ui.search.either'/></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan='4'><s2ui:submitButton elementId='search' form='userSearchForm' messageCode='wellmia.security.ui.search'/></td>
			</tr>
			</tbody>
		</table>
	</g:form>
