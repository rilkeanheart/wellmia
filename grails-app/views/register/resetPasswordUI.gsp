<head>
<title><g:message code='wellmia.security.ui.resetPassword.title'/></title>
...
<s2ui:form width='475' height='250' elementId='resetPasswordFormContainer'
           titleCode='wellmia.security.ui.resetPassword.header' center='true'>
	...
	<br/>
	<h4><g:message code='wellmia.security.ui.resetPassword.description'/></h4>
	...
	<s2ui:submitButton elementId='reset' form='resetPasswordForm' messageCode='wellmia.security.ui.resetPassword.submit'/>
