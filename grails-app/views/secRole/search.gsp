<head>
	...
	<title><g:message code='wellmia.security.ui.role.search'/></title>
</head>
...
<div>
	...
	<s2ui:form width='100%' height='200' elementId='formContainer'
	      titleCode='wellmia.security.ui.role.search'>
	...
	<g:form action='roleSearch' name='roleSearchForm'>
		...
		<table>
			...
			<tr>
				<td colspan='2'><s2ui:submitButton elementId='search' form='roleSearchForm' messageCode='wellmia.security.ui.search'/></td>
			</tr>
			</tbody>
		</table>
	</g:form>
