...
<%
def tabData = []
tabData << [name: 'roleinfo', icon: 'icon_role',  messageCode: 'wellmia.security.ui.role.info']
tabData << [name: 'users',    icon: 'icon_users', messageCode: 'wellmia.security.ui.role.users']
%>
...
<s2ui:tabs elementId='tabs' height='150' data="${tabData}">
	...
	<s2ui:tab name='users' height='150'>
		...
		<g:message code="wellmia.security.ui.role_no_users"/>
		</g:if>
