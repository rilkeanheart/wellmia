<head>
	...
	<title><g:message code='wellmia.security.ui.registrationCode.search'/></title>
</head>
...
<div>
	...
	<s2ui:form width='100%' height='200' elementId='formContainer'
	      titleCode='wellmia.security.ui.registrationCode.search'>
	...
	<g:form action='registrationCodeSearch' name='registrationCodeSearchForm'>
		...
		<table>
			...
			<tr>
				<td colspan='2'><s2ui:submitButton elementId='search' form='registrationCodeSearchForm' messageCode='wellmia.security.ui.search'/></td>
			</tr>
			</tbody>
		</table>
	</g:form>
